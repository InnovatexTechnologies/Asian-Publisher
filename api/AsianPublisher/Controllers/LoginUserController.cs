...
namespace AsianPublisher.Controllers
{
    ...
    new DataColumn("Password"),
        ...
        public FileContentResult GeneratePdf(string id)
        {
            ...
            table.AddCell(cell);
            cell = new PdfPCell(new Phrase("User Name", fontd));
            cell.HorizontalAlignment = 1;
            table.AddCell(cell);
            cell = new PdfPCell(new Phrase("Password", fontd));
            cell.HorizontalAlignment = 1;
            table.AddCell(cell);
            int v = 1;
            foreach (LoginUser obj1 in model)
            {
                ...
                cell.HorizontalAlignment = 1;
                table.AddCell(cell);
                cell = new PdfPCell(new Phrase(obj1.password, fonta));
                cell.HorizontalAlignment = 1;
                table.AddCell(cell);
                v++;
            }
