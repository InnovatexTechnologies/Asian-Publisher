          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                ...
                <p>Welcome to Asian Publishers!</p>
                <p>
                  These terms and conditions outline the rules and regulations
                  for the use of Asian Publishers's Website, located at
                  https://asianpublisher.in/.
                </p>
                <p>
                  By accessing this website we assume you accept these terms and
                  conditions. Do not continue to use Asian Publishers if you do
                ...
                <p>
                  We employ the use of cookies. By accessing Asian Publishers,
                  you agreed to use cookies in agreement with the Asian
                  Publishers's Privacy Policy.{" "}
                </p>
                <p>
                ...
                <p>
                  Unless otherwise stated, Asian Publishers and/or its licensors
                  own the intellectual property rights for all material on Asian
                  Publishers. All intellectual property rights are reserved. You
                  may access this from Asian Publishers for your own personal
                  use subjected to restrictions set in these terms and
                  conditions.
                </p>
                <p>You must not:</p>
                <ul>
                  <li>Republish material from Asian Publishers</li>
                  <li>
                    Sell, rent or sub-license material from Asian Publishers
                  </li>
                  <li>
                    Reproduce, duplicate or copy material from Asian Publishers
                  </li>
                  <li>Redistribute content from Asian Publishers</li>
                </ul>
                <p>
                ...
                <p>
                  ...
                  website. Asian Publishers does not filter, edit, publish or
                  review Comments prior to their presence on the website.
                  Comments do not reflect the views and opinions of Asian
                  Publishers,its agents and/or affiliates. Comments reflect the
                  views and opinions of the person who post their views and
                  opinions. To the extent permitted by applicable laws, Asian
                  Publishers shall not be liable for the Comments or for any
                ...
                <p>
                  Asian Publishers reserves the right to monitor all Comments
                ...
                <p>
                  You hereby grant Asian Publishers a non-exclusive license to
                ...
                <p>
                  ...
                  compensates the absence of Asian Publishers; and (d) the link
                ...
                <p>
                  ...
                  inform us by sending an e-mail to Asian Publishers. Please
                ...
                <p>
                  No use of Asian Publishers's logo or other artwork will be
